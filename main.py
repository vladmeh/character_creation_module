...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляет блокированный урон игороком."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Вычисляет применение специального умения игроком."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Тренировка владения навыками игрока."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбирает игрока и подтверждает выбор пользователя."""
    approve_choice: str = ''
    char_class: str = ''
